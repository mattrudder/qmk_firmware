...
// User-defined effect
 #define RGB_BACKLIGHT_EFFECT 11
...
#define RGB_BACKLIGHT_LAYER_1_INDICATOR { .color = { .h = 127, .s = 255 }, .index = 255 }
#define RGB_BACKLIGHT_LAYER_2_INDICATOR { .color = { .h = 32, .s = 255 }, .index = 255 }
#define RGB_BACKLIGHT_LAYER_3_INDICATOR { .color = { .h = 196, .s = 0 }, .index = 255 }
